import {connectDB, getUserIdByEmail, updateCurrentUser, updateIceCreamStackInDatabase} from "@/utils/database";
...
export async function POST(req: Request) { // todo: refine :any type
    ...
    try {
        ...
        await updateIceCreamStackInDatabase(userId, requestObjectInJSON.iceCreamStack);
